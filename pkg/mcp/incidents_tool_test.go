...
func (m *MockPromAPI) LabelNames(ctx context.Context, matches []string, startTime, endTime time.Time, options ...v1.Option) ([]string, v1.Warnings, error) {
	return nil, nil, nil
}

func (m *MockPromAPI) LabelValues(ctx context.Context, label string, matches []string, startTime, endTime time.Time, options ...v1.Option) (model.LabelValues, v1.Warnings, error) {
	return nil, nil, nil
}
...
func (m *MockPromAPI) Series(ctx context.Context, matches []string, startTime, endTime time.Time, options ...v1.Option) ([]model.LabelSet, v1.Warnings, error) {
	return nil, nil, nil
}
...
func (m *MockPromAPI) TSDB(ctx context.Context, options ...v1.Option) (v1.TSDBResult, error) {
