	...
	tests := []struct {
	...
	}{
		{
			...
			expectedIncidents: []Incident{
				{
					GroupId:   "1",
					StartTime: "2025-06-17T00:49:43+02:00",
					Alerts: []model.Metric{
						{
							"alertname":  "Alert1",
							"namespace":  "foo",
							"start_time": "2025-06-17T00:49:43+02:00",
						},
						{
							"alertname":  "Alert1",
							"namespace":  "bar",
							"start_time": "2025-06-20T12:09:43+02:00",
						},
					},
				},
			},
			...
			expectedIncidents: []Incident{
				{
					...
					Alerts: []model.Metric{
						...
						},
						{
							"alertname":  "Alert1",
							"namespace":  "bar",
							"start_time": "2025-06-20T12:09:40+02:00",
						},
					},
				},
				{
